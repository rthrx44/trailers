    ...
    <>
      <div className="drawer drawer-end">
        ...
        <div className="drawer-content">
          {/* Page content here */}
          <header className='container mx-auto flex justify-between items-center bg-[#141414] color-[#fff] pl-4 py-2 md:py-4'>
            <div>
              <img src={Trailers} alt="Trailers Logo" className='h-5 xs:h-6 lg:h-7' />
            </div>
            <div className='flex items-center md:gap-6'>
              <form className='tracking-widest relative'>
                <input type="text" placeholder='SEARCH' className='pl-2 py-1 w-32 rounded-sm text-xs font-semibold outline-none focus:outline-1 focus:outline-red-700 transition-all ease-in-out lg:text-sm' />
              </form>
              ...
              <ul className='gap-6 text-xs tracking-widest hidden md:flex md:items-center md:pr-4 lg:text-sm'>
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-3/6 min-h-full text-base-content bg-[#141414] color-[#fff] gap-6">
            ...
            <div className='flex flex-col justify-center items-center text-xs gap-8 tracking-widest lg:text-sm'>
